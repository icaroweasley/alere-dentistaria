...
const FooterSection = () => {
  return (
    <footer id="contato" className="bg-white pt-24 pb-12 overflow-hidden">
      {/* Location Section */}
      <div className="max-w-7xl mx-auto px-6 mb-24">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="w-full h-[450px] rounded-[3rem] overflow-hidden shadow-2xl shadow-gray-200 border-8 border-white"
        >
          <iframe 
      ...
      <div className="max-w-7xl mx-auto px-6 mb-24 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <motion.a
            ...
            whileHover={{ y: -10 }}
            className="flex flex-col items-center text-center p-12 rounded-[3.5rem] bg-gray-50/50 hover:bg-white transition-all duration-300 group shadow-sm hover:shadow-2xl hover:shadow-gray-200"
          >
      ...
      <div className="bg-medical-blue py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-8">
          <h3 className="text-white text-3xl font-medium tracking-tight">Nos Siga Nas Redes !</h3>
