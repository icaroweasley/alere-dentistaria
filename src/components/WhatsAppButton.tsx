...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      {/* Realism Tooltip */}
      <div className="absolute right-full mr-6 top-1/2 -translate-y-1/2 px-5 py-2.5 bg-white/20 backdrop-blur-2xl border border-white/30 rounded-2xl shadow-xl opacity-0 group-hover:opacity-100 transition-all duration-500 whitespace-nowrap hidden md:block">
