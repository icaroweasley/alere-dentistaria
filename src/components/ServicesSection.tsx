      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-20 space-y-4">
          ...
          >
            ...
            <span className="text-alere-plum font-['Adelia'] text-5xl sm:text-6xl md:text-7xl font-normal leading-tight drop-shadow-sm px-8 tracking-tighter whitespace-nowrap">Especialidades</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
